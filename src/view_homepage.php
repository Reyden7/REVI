...
<div class="container-fluid">
  <div style="background:white; width:110%; margin-top:45.5rem; margin-left:-2rem; height:1rem; filter:blur(5px); position:fixed; z-index:1"></div>
</div>

<div class="container-fluid">
  <div class="row">
    <div class="col-4"></div>
    <div class="col-4"> <div  id="arrow" style=" background:url('fleche.png');   width:100%; margin-top:46.5rem; margin-left:15rem;  height:100%; position:fixed ; z-index:10; background-repeat: no-repeat;" ></div></div>
    <div class="col-4"></div>
  </div>
</div>
...
<div class="container"data-aos="fade-up" >
  <div class="row" >
  <h2 class="mt-5" id="text" style="text-align: justify;">Ce master comprend deux parcours, un parcours Ingénierie de la Recherche et un parcours Veille Internationale. Il s’adresse à des étudiants diplômés en langue étrangère (allemand, anglais, espagnol, niveau licence LLCER ou équivalent. Le niveau requis en français: C2. Débouchés: – chargé de veille, analyste en e-réputation, analyste de données d’opinion – enseignant, enseignant-chercheur, travail dans l’administration de la recherche.
 </h2> </div>

</div>

<div class="mt-5 "  id=para1> 
</div>

<div data-aos="fade-up" class="container-fluid backgroundBande  "  style="margin-top: -80px; margin-left:-2%">
  <div class="row-full shadow  ">
      <span class="text-center "> 
        <div class="row ">
...
<div class="container-fluid mt-5 ">
  <div class="row">
    <div class="col-4" data-aos="fade-right" data-aos-offset="300" data-aos-easing="linear" >
    ...
    <div class="col-7" style="margin-left:7%" data-aos="fade-left"  data-aos-offset="300" data-aos-easing="linear" >
...
<div class="container-fluid mt-5 " style="margin-bottom: 10rem;" data-aos="fade-up" data-aos-offset="300" data-aos-easing="linear">
  <div class="row">
    <div class="col-7" data-aos="fade-right">
        <video style="height: 115%;margin-left: -2%" src="veille2.mp4" autoplay loop muted></video>
    </div>
    <div class="col-4" style="margin-left:4%" data-aos="fade-left" data-aos-offset="300" data-aos-easing="linear">
...
<div class="container-fluid backgroundBande  mt-2" data-aos="fade-up" style="margin-top: -80px; margin-left:-2%">
  <div class="row-full shadow  ">
      <span class="text-center "> 
        <div class="row ">
          <div class="col-4 pt-2" >
...
<div class="container-fluid backgroundBande  " data-aos="fade-up" style="margin-top: -80px; margin-left:-2%">
  <div class="row-full shadow  ">
      <span class="text-center "> 
        <div class="row ">
          <div class="col-4 pt-2" >
...
<div class="container mt-5 " data-aos="fade-up">
  <div class=" row ">
    <div class="marquee align-content-center">
      <ul class="marquee-content">
      <li><a href="https://www.opinionact.com/" title="OpinionAct"><img alt="OpinionAct" src="img/OA.png" width="20%"  aria-hidden="true"  class="w-50"/></a></i></li>
        <li><a href="https://www.webdrone.fr/fr/" title="WebDrone"><img alt="WebDrone" src="img/wd.png" width="-50" aria-hidden="true" class="w-50"/></a></i></li>
        <li><a href="https://www.idaos.com/" title="Idaos"><img alt="Idaos" src="img/Idaos.png" width="-50" aria-hidden="true" class="w-50"/></a></i></li> 
